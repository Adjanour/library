...
<div class="fixed inset-0 bg-surface-0 z-40 flex flex-col">
  <!-- Reader header -->
  <div class="flex items-center gap-3 px-4 py-2 border-b border-border bg-surface-1 shrink-0">
    <button class="p-1.5 rounded hover:bg-surface-3 transition-colors" title="Close (Esc)" onclick={onClose}>
    ...
    <button class="p-1.5 rounded hover:bg-surface-3 transition-colors" title="Previous" onclick={prev}>
    ...
    <button class="p-1.5 rounded hover:bg-surface-3 transition-colors" title="Next" onclick={next}>
